...
@section('title', 'Coretan Kecil - Kategori') 
            ...
            <tr>
              ...
              <td width="20%">
                <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <a href="/kategori/{{ $row->id }}/konfirmasi" class="btn btn-danger btn-sm mr-1"><i class="fas fa-trash"></i> Hapus</a>
                </div>
              </td>
            </tr>
          @endforeach
