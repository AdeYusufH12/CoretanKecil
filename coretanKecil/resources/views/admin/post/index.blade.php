...
@section('title', 'Coretan Kecil - Post') 
@section('post', 'active') 
@section('main', 'show') 
        ...
        <table class="table mt-4 table-hover table-bordered">
            ...
            @foreach ($post as $row)
                ...
                <td width="35%">
                    ...
                    <a href="/post/{{ $row->id }}" class="btn btn-info btn-sm mr-1"><i class="fas fa-eye"></i> Lihat</a>
                    <a href="/post/{{ $row->id }}/edit" class="btn btn-primary btn-sm mr-1"><i class="fas fa-edit"></i> Ubah</a>
